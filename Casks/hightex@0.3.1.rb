cask "hightex@0.3.1" do
  version "0.3.1"

  url "https://github.com/jefyokta/hightex-desktop/releases/download/v#{version}/HighTex-Mac-0.3.1-Installer.dmg"
  sha256 "3b7903580157308e1a92ad6aa01c3a7bfb35dca938342b29068378fd8a18eaad"
